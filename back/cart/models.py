...
class cart (models.Model):
    ...
    Estimated_arrival=models.IntegerField(validators=[MinValueValidator(0),MaxValueValidator(60)],default=60)
    promo_code=models.CharField(max_length=30,null=True)
