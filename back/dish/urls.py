...
from .views import DishDetail,dishCreateAPIView,dishlistAPIView,like_dishAPIView,favourite_dishAPIView,add_dish_to_cart_APIView,del_dish_from_cart_APIView,like_dislike
urlpatterns = [
    ...
    path('likedislike/<int:pk>/', like_dislike.as_view(), name="like or dislike dish")
