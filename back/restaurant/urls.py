...
from .views import restaurantListAPIView,restaurantDetailAPIView,like_restAPIView,favourite_restAPIView,list_of_dishes,restaurantCreateAPIView,like_doNotLike
urlpatterns= [
    ...
    path('likedislike/<int:pk>/', like_doNotLike.as_view(), name="like or don't like")
